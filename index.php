  ...
  <body>
    ...
    <div class="chapters">
      ...
      <div class="chapter"  id="chapter-two">
        ...
        <audio controls>
          <source src="tracks/2_with_audio.mp3" type="audio/mp3">
        </audio>
        <div class="next">
      ...
      <div class="chapter"  id="chapter-three">
        ...
        <audio controls>
          <source src="tracks/3_with_audio.mp3" type="audio/mp3">
        </audio>
        <div class="next">
      ...
      <div class="chapter"  id="chapter-four">
        ...
        <audio controls>
          <source src="tracks/4_with_audio.mp3" type="audio/mp3">
        </audio>
        <div class="next">
      ...
      <div class="chapter"   id="chapter-five">
        ...
        <audio controls>
          <source src="tracks/5_with_audio.mp3" type="audio/mp3">
        </audio>
        <div class="next">
      ...
      <div class="chapter"   id="chapter-six">
        ...
        <audio controls>
          <source src="tracks/6_with_audio.mp3" type="audio/mp3">
        </audio>
        <div class="next">
      ...
      <div class="chapter" id="chapter-seven">
        <p>
          One day, in the deepest corner of the Ghetto, I found him lying on the ground.
          For months, I treated his wounds. We were finally back together but we knew there were more people to rescue.
          That´s why we chose to fight back.
        </p>
        <audio controls>
          <source src="tracks/7_with_audio.mp3" type="audio/mp3">
        </audio>
      </div>
